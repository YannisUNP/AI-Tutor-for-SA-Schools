function Footer(){
    return (
        <footer className="bg-surface-container-low dark:bg-surface-container-highest w-full py-8 px-margin-desktop">
            ...
            <div className="max-w-container-max mx-auto border-t border-outline-variant/30 mt-0 pt-0 text-center md:text-left">
                <p className="font-caption text-caption text-on-surface-variant">
                    © 2026 StudyMate. Supporting South African Excellence. All rights reserved.
                </p>
            </div>
        </footer>
    );
